  ...
  return (
    <Section number="03" title="Professional Scope">
      <div className="flex flex-col">
        {items.map((item, idx) => (
          <div key={idx} className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 border-b-[0.5px] border-gray-100 py-6 md:py-8 first:pt-0 last:border-0 break-inside-avoid">
            {/* Context/Period - Mobile: Top metadata */}
            ...
            <div className="md:col-span-6 pl-0 md:pl-2">
              <ul className="space-y-3">
                {item.description.map((desc, dIdx) => (
                  <li key={dIdx} className="text-sm text-gray-700 leading-snug font-sans flex items-start">
