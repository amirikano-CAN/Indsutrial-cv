  ...
  return (
    <Section number="02" title="Certifications & Professional Validation">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 print:grid-cols-2 print:gap-x-12 print:gap-y-4">
        {items.map((cert, idx) => (
          <div key={idx} className="flex flex-col gap-4 print:gap-1 group break-inside-avoid">
            <div className="h-5 print:h-4 w-auto flex items-center justify-start opacity-60">
               {(() => {
            ...
            <div className="flex flex-col border-l-2 border-gray-100 pl-3 print:pl-2">
