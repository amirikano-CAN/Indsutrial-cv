...
export const cvData: CVData = {
  ...
  contact: {
    ...
    email: "amyr.labidi@email.com",
    linkedin: "linkedin.com/in/amyr-labidi",
    portfolio: "behance.net/amyrlabidi"
  },
  skillCategories: [
    {
  ...
  projects: [
    {
      title: "Sphezor - The Soft Razor",
      tags: ["Industrial", "Prototype", "Device"],
      description: "A compact grooming device focused on softness and ergonomics. The device explores skin continuity, tactile feedback, and manufacturable detailing for personal care products.",
      imageUrl: "https://image2url.com/r2/default/images/1769543946016-02cd3e38-01b9-42c4-9577-cd11a02e15e7.blob"
    },
    {
      title: "BIC - The Factory Museum",
      tags: ["Store", "Factory management", "Retail"],
      description: "An industrial exhibition system designed to translate complex manufacturing processes into clear, physical storytelling. The project balances precision, durability, and visitor flow within an active factory environment.",
      imageUrl: "https://mir-s3-cdn-cf.behance.net/projects/max_808/61113a159927313.Y3JvcCwxNjA3LDEyNTcsMCww.png"
    },
    {
      title: "Shahad - The Minimalistic Luxurious Packaging",
      tags: ["Packaging", "Luxury", "Honey"],
      description: "A premium packaging concept combining minimal aesthetics with technical clarity. The project focuses on material honesty, structural simplicity, and refined graphic balance for luxury food products.",
    ...
    },
    {
      ...
      tags: ["Sport Lifestyle", "Daily Use", "Fragrance Design"],
      description: "A modular fragrance system combining perfume and deodorant into one compact, intuitive object designed for everyday performance.",
